...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('Ethree/GF_nya');
				frames = tex;
			...
			case 'bf-pixel-dead':
				...
				flipX = true;
			case 'bf-miku':
				var tex = Paths.getSparrowAtlas('Ethree/BOYFRIEND', 'shared');
				frames = tex;
				...
				addOffset('idle');
				addOffset("singUP", -67, 46);
				addOffset("singRIGHT", -85, 15);
				addOffset("singLEFT", -12, -6);
				addOffset("singDOWN", -57, -37);
				addOffset("singUPmiss", -67, 46);
				addOffset("singRIGHTmiss", -30, 21);
				addOffset("singLEFTmiss", -12, 24);
			...
			case 'beepie-normal':
				tex = Paths.getSparrowAtlas('Ethree/beepienormal_assets');
				frames = tex;
